...
Έστησα την κάμερα με τρόπο ώστε στην αρχή να δίνει μεγαλύτερη εστίαση στην γάτα όπως φαίνεται και πιο κάτω. Στην συνέχεια στον τουρίστα και έπειτα στην κοπέλα. 
